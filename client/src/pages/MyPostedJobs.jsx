    ...
    toast(
      (t) => (
        <div className='flex gap-4 items-center'>
          ...
          <div>
            <button className='btn bg-red-400 p-4 ' onClick={() => {
              toast.dismiss(t.id)
              handleDlete(id)
              toast.dismiss(t.id)
            ...
            >Yes</button>
            <button className='btn bg-green-400 p-4 m-2' onClick={() => toast.dismiss(t.id)}>Cancel</button>
          </div>
                    ...
                    jobs.map(job => <tr key={job._id}>
                      ...
                      <td className='px-4 py-4 text-sm whitespace-nowrap'>
                        <div className='flex items-center gap-x-6'>
                          <button onClick={() => moderDelete(job._id)} className='text-gray-500 transition-colors duration-200   hover:text-red-500 focus:outline-none'>
                            <svg
